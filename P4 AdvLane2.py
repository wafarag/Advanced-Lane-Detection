...
Test_images_path = "C:/work/MyFiles/Research/DeepLearning/CarND/AdvLaneDetect/CarND-Advanced-Lane-Lines-master/test_images/"
Output_path = "C:/work/MyFiles/Research/DeepLearning/CarND/AdvLaneDetect/CarND-Advanced-Lane-Lines-master/output_images/"
Camera_Cal_images_path = "C:/work/MyFiles/Research/DeepLearning/CarND/AdvLaneDetect/CarND-Advanced-Lane-Lines-master/camera_cal/"
Data_path = "C:/work/MyFiles/Research/DeepLearning/CarND/AdvLaneDetect/CarND-Advanced-Lane-Lines-master/data/"
Video_path = "C:/work\MyFiles/Research/DeepLearning/CarND/AdvLaneDetect/CarND-Advanced-Lane-Lines-master/"
...
#=====================================================================================
#=====================================================================================
#================= Start Defining HLS & HSV Color Maps / Gradient functions ==========
#=====================================================================================
...
def Color_Gradients_pipeline(img):
    ...
    abs_sobelx_binary    = Abs_Sobel_Thresh(img, orient='x', thresh_min=20, thresh_max=200)
    abs_sobely_binary    = Abs_Sobel_Thresh(img, orient='y', thresh_min= 150, thresh_max=180)
    mag_threshold_binary = Mag_Thresh(img, sobel_kernel=9, mag_thresh=(100, 200))
    ...
    # Combine both the results of the S Channel slection and Sobel Gradients
    combined_sobel_s_channel = np.zeros_like(abs_sobelx_binary)
    combined_sobel_s_channel[(hls_S_channel == 1) | (combined_sobel == 1)] = 1
    #return_binary
    return combined_sobel_s_channel, hls_S_channel
#=====================================================================================
...
def process_image(Test_img):
    ...
    Color_Gradients_result, S_channel_img = Color_Gradients_pipeline(undistorted_Test_img)
    # Plot the result of applying Color mappings like HLS & HSV and Sobel Gradients
    # on the undistorted image
    if not is_Video:
        Display_Two_Adjacent_Images(S_channel_img, "S Channel Image", 'gray',
...
if is_Video:
    ...
    video_input1 = VideoFileClip(Video_path+'project_video.mp4')#.subclip(22,26)
